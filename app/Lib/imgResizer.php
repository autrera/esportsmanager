...
function resize($imagePath,$opts=null){
	# start configuration
	$cacheFolder = '/home2/criosis1/cache/'; # path to your cache folder, must be writeable by web server
	...
	if(isset($purl['scheme']) && $purl['scheme'] == 'http'):
		...
		if(file_exists($local_filepath)):
			if(time() < strtotime('+'.$opts['cache_http_minutes'].' minutes', filemtime($local_filepath))):
